...
# Customize only what you really need and notice that Pagy works also without any of the
# following lines.
...
# example of width/size pairs
# Pagy::VARS[:breakpoints] = { 0 => [1,2,2,1], 350 => [2,3,3,2], 550 => [3,4,4,3] }
...
Pagy::VARS[:overflow] = :last_page # (other options: :empty_page and :exception)
