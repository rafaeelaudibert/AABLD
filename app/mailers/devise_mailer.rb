...
class DeviseMailer < Devise::Mailer
  ...
  def confirmation_instructions(record, token, opts = {})
    mail = super
    mail.subject = '[AABLD] - Instruções de Confirmação'
    mail
  end
  ...
  def email_changed(record, token, opts = {})
    mail = super
    mail.subject = '[AABLD] - Alteração de e-mail'
    mail
  end

  # Email which is sent when a user is invited to
  # the AABLD Portal, containing his account
  # creation instructions
  def invitation_instructions(record, token, opts = {})
    mail = super
    mail.subject = '[AABLD] - Instruções de Criação'
    mail
  end
  ...
  def password_change(record, token, opts = {})
    mail = super
    mail.subject = '[AABLD] - Alteração de senha'
    mail
  end
  ...
  def unlock_instructions(record, token, opts = {})
    mail = super
    mail.subject = '[AABLD] - Instruções de Desbloqueio'
    mail
  end
end
